...
Util = {
    leftDistance: function(a) {
        ...
        c = void 0; a.offsetParent;) a = a.offsetParent,
        b += a.offsetLeft;
...
skPlayer = function() {
    function a(b) {
        var c = this;
        if (_classCallCheck(this, a), instance) return console.error("SKPlayer只能存在一个实例！"),
        Object.create(null);
        instance = !0;
        var d = {
        ...
        if (this.option = b, !(this.option.music && this.option.music.type && this.option.music.source)) return console.error("请正确配置对象！"),
        Object.create(null);
        ...
        "file" === this.type ? (this.root.innerHTML = this.template(), this.init(), this.bind(), this.isReady = !0) : "cloud" === this.type && (this.root.innerHTML = '<p class="skPlayer-tip-loading"><span></span> <span></span> <span></span> <span></span><span></span></p>', Util.ajax({
